      ...
      >
        <div className="px-8">
          ...
          <p className="my-4 font-light md:text-xl">
            Hi 👋 I'm an enthusiastic web developer. I can sit on both ends of
            an application, and my Vietnamese name is{" "}
            <span className="font-bold">Dat.</span>
          </p>
          <p className="my-2 pl-4 font-light">
            Here's a quick summary of my skills set:
          </p>
          <ul className="pl-4 flex flex-col gap-4 font-extralight text-gray-600 dark:text-gray-400 bg-black/10 p-8 rounded">
            ...
            <li className="pl-10 md:text-xl">
              I could also implement <span className="text-pink-500 font-bold">GraphQL</span> API using <span className="text-indigo-700 font-bold">Apollo</span> framework and do a
